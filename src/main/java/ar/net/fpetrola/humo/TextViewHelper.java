...
public class TextViewHelper
{
    ...
    public static HumoStyledDocument createStyleDocument()
    {
	...
	return new HumoTextDocument(styleContext);
    }
    ...
    public static HumoStyledDocument createAndSetupDocument(StringBuilder sourceCode)
    {
	HumoStyledDocument styleDocument= createStyleDocument();
